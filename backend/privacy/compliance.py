...
class KVKKCompliance:
    ...
    def handle_data_subject_request(
        self, request_type: str, captain_id: str, details: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        """
        ...
        if not handler:
            return {"success": False, "reason": f"Unknown request type: {request_type}"}

        return handler(captain_id, details)

    def _handle_access_request(self, captain_id: str, details: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def _handle_rectification_request(self, captain_id: str, details: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def _handle_erasure_request(self, captain_id: str, details: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def _handle_restriction_request(self, captain_id: str, details: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def _handle_portability_request(self, captain_id: str, details: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def _handle_objection_request(self, captain_id: str, details: Optional[Dict[str, Any]]) -> Dict[str, Any]:
...
class GDPRCompliance:
    ...
    def validate_legal_basis(self, processing_data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _get_legal_basis_justification(self, legal_basis: DataProcessingPurpose) -> str:
